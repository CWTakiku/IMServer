...
public class ResponseModel<M> implements Serializable {
    ...
    // 没有找到群成员信息
    public static final int ERROR_NOT_FOUND_ARTICLE = 4044;
    //没有找到学校
    public static final int ERROR_NOT_FOUND_Schools_MEMBER = 4045;
    //获取圈失败
    public static final int ERROR_NOT_FOUND_CIRCLE_MEMBER = 4051;

    //获取评论失败
    public static final int ERROR_NOT_FOUND_COMMENT_MEMBER = 4061;
    ...
    // 账户短信验证码获取失败
    public static final int ERROR_ACCOUNT_SMS = 2004;
    //短信验证码错误
    ...
    public static <M> ResponseModel<M> buildNotFoundGroupError(String str) {
        return new ResponseModel<M>(ERROR_NOT_FOUND_GROUP, str != null ? str : "Not Found Community.");
    }
